...
7. `GET /api/players`
8. `GET /api/players/team-squads`
9. `GET /api/tournaments/current-seasons`
10. `GET /api/teams/:id`
11. `GET /api/teams/:id/stats`
12. `GET /api/players?teamId=:teamId`
13. `GET /api/players/:id`
14. `GET /api/standings?tournamentId=:tournamentId&seasonId=:seasonId` returns grouped standings with `selectedGroupKey`; each row includes `team_logo` when available.
15. Error-case requests
