...
const TEAM_STAT_META = defineTeamStatMeta({
  ...
  dribbles_success: { label: "Dribbles Successful" },
  dribbles_attempts: { label: "Dribbles Attempted" },
  ...
  dribbles_against_total: { label: "Dribbles Attempted Against" },
  dribbles_against_acc: { label: "Dribbles Successful Against" },
