...
```json
{
  "data": {
    "teams": [
      { "id": 12, "name": "Olympiacos" }
    ],
    "players": [
      { "id": 99, "name": "Player Name" }
    ]
  }
}
```
